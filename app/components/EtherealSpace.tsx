...
export default function EtherealSpace() {
  ...
  const [tempoValue, setTempoValue] = useState(1.2);
  ...
  return (
    <div className="h-screen w-screen overflow-hidden bg-stone-200">
      <Header />
      
      <div
        id="space"
        ref={spaceRef}
        className="w-screen h-screen relative bg-gradient-radial-custom from-stone-50 via-stone-200 via-50% to-stone-300"
      >
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="absolute w-[300px] h-[300px] rounded-full bg-gradient-radial from-stone-50/50 via-stone-100/20 to-transparent" />
          
          <div className="absolute w-[200px] h-[200px] rounded-full border-[1px] border-stone-300/30 bg-gradient-radial from-transparent via-stone-200/30 to-stone-300/20 shadow-[0_0_40px_rgba(0,0,0,0.1)] backdrop-blur-[1px]" />
          
          <div className="absolute w-[180px] h-[180px] rounded-full bg-gradient-radial from-white/5 via-transparent to-transparent" />
        </div>
      </div>
      
      <div className="fixed left-8 top-1/2 -translate-y-1/2 bg-white/30 backdrop-blur-sm p-5 rounded-2xl flex flex-col gap-12 items-center border border-white/20 w-[120px]">
        <div className="flex flex-col gap-3 w-full items-center">
          <label className="text-sm font-medium text-stone-600">Root</label>
          <select
      ...
      <div className="fixed right-8 top-1/2 -translate-y-1/2 bg-white/30 backdrop-blur-sm p-5 rounded-2xl flex flex-col gap-12 items-center border border-white/20 w-[120px]">
        <div className="flex flex-col gap-3 w-full items-center">
      ...
      {isRefreshing && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <div 
            className="bg-white/20 backdrop-blur-sm px-8 py-4 rounded-lg border border-white/20 transition-opacity duration-1000"
          >
